...
**MEMORY.md is mandatory in main sessions.** If you don't read it at startup, you lose continuity with Kevin. Always load it before responding.
...
- **Before deleting any file, READ it first** to ensure no important information is lost.
- When in doubt, ask.
